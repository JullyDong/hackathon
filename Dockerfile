...
# Set config defaults for JDBC
ENV EFAK_DB_DRIVER=com.mysql.cj.jdbc.Driver
ENV EFAK_DB_USERNAME=root
ENV EFAK_DB_PASSWORD=123456
ENV EFAK_DB_URL=jdbc:mysql://eagledb:3306/ke?useUnicode=true&characterEncoding=UTF-8
